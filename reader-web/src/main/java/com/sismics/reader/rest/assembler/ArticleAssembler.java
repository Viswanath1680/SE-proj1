...
public class ArticleAssembler {
    ...
    /**
     * Converts a UserArticleDto object into a JSON representation containing article metadata like title,
     * subscription details, URL, dates, creator, description, comments and read/starred status.
     * 
