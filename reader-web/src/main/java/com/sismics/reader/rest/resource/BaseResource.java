 ...
 */
/**
 * Base class for REST resources that provides common functionality for authentication and authorization.
 * It injects the HTTP request and application key, and offers methods to check user authentication and base function permissions.
 */
