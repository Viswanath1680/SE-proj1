 ...
 * REST resource handling article-related operations for a feed reader application.
 * Provides endpoints to:
 * - Mark individual articles as read/unread
 * - Mark multiple articles as read/unread in batch
 * - Update read status and unread counts in feed subscriptions
 * - Authenticate users before allowing article operations
 * 
 * This resource extends BaseResource to inherit authentication and authorization capabilities.
 * It interacts with ArticleDao, UserArticleDao and FeedSubscriptionDao to manage article states
