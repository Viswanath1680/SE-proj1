...
/**
 * Represents an article entity in the database. This class encapsulates the properties and behavior of an article,
 * including its ID, feed ID, URL, GUID, title, creator, description, comment URL, comment count, enclosure URL,
 * enclosure length, enclosure type, publication date, creation date, and deletion date.
 */
@Entity
@Table(name = "T_ARTICLE")
